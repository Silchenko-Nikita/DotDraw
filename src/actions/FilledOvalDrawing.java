...
public class FilledOvalDrawing implements Action {
    int instrumentSize;
    Dot startDot;
    Dot endDot;
    Color color;

    public FilledOvalDrawing(Dot initPos, Color color, int instrumentSize) {
        startDot = initPos;
        this.color = color;
    ...
    public void apply(Graphics g) {
        ...
        g.fillOval(startDot.getX() + (width >= 0 ? 0 : width),
